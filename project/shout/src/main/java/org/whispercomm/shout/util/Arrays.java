...
public class Arrays {
	 ...
	 *         found.
	 * @throws ClassCastException if the array contains elements that are not
	 *             <i>mutually comparable</i> using the specified comparator, or
	 *             the search key is not comparable to the elements of the array
	 ...
	 *             <i>mutually comparable</i> using the specified comparator, or
	 *             the search key is not comparable to the elements in the range
	 *             using this comparator.
	 * @throws IllegalArgumentException if {@code fromIndex > toIndex}
	 * @throws ArrayIndexOutOfBoundsException if
	 *             {@code fromIndex < 0 or toIndex > a.length}
	 ...
	 * @param a the array to be filled
	 * @param val the value to be stored in all elements of the array
	 * @throws ArrayStoreException if the specified value is not of a runtime
	 ...
	 * @throws NegativeArraySizeException if <tt>newLength</tt> is negative
	 * @throws NullPointerException if <tt>original</tt> is null
	 * @throws ArrayStoreException if an element copied from <tt>original</tt>
	 *             is not of a runtime type that can be stored in an array of
	 *             class <tt>newType</tt>
	 * @since 1.6
	 */
