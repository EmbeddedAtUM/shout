 ...
 * 
 */
public class Shout extends JSONObject {
	 ...
	 * @param serial_num
	 *            shout serial num of the originator
	 * @param content
	 *            content
	 * @param signature
	 ...
	 */
	public Shout(long date, String user_name, String public_key,
	 ...
	 * @throws JSONException
	 */
	public Shout(byte[] shoutBytes) throws UnsupportedEncodingException,
			JSONException {
